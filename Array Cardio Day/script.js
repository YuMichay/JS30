    ...
    const first = inventors.filter((inventor) => inventor.year >= 1500 && inventor.year <= 1599);
    ...
    const forth = inventors.reduce((sum, inventor) => sum += inventor.passed - inventor.year, 0);
    console.log("forth: ", forth);
    
    // 5. Sort the inventors by years lived
    const fifth = inventors.sort((a, b) => (a.passed - a.year) - (b.passed - b.year));
    console.log("fifth: ", fifth);

    // 6. create a list of Boulevards in Paris that contain 'de' anywhere in the name
    const list = ["Boulevards of Paris", "City walls of Paris", "Thiers wall", "Wall of Charles V",
    ...
    "Boulevard du Crime", "Boulevard du Général-d'Armée-Jean-Simon", "Boulevard Haussmann",
    "Boulevard de l'Hôpital", "Boulevard des Italiens", "Boulevard Lefebvre", "Boulevard de la Madeleine",
    "Boulevard de Magenta", "Boulevard Malesherbes", "Boulevard Marguerite-de-Rochechouart",
    ...
    const sixth = list.filter((boulevard) => boulevard.includes("de"));
    console.log("sixth: ", sixth);

    // 7. sort Exercise
    // Sort the people alphabetically by last name
    const seventh = people.sort((a, b) => {
    ...
    const eighth = data.reduce((obj, instance) => {
        if (instance in obj) {
            obj[instance] ++;
        } else {
            obj[instance] = 0;
